...
### Golf 0: Opruiming (actief)

| Sprint | Track | Size | Status | Hill |
|--------|-------|------|--------|------|
| Quick Fixes Ops Validatie | — | XS | ✅ DONE | ████████████ |
| Planning Opschoning | — | XS | 📋 KLAAR | ░░░░░░░░░░░░ |

### Golf 1: Fundament (volgende)

Alle Sprint 1's zijn ongeblokkeerd en raken verschillende codepaden. Max 2-3 tegelijk aanbevolen.

| Sprint | Track | Size | Status | Hill | Codepad |
|--------|-------|------|--------|------|---------|
| Storage: Interface + LocalAdapter | B | S | 📋 KLAAR | ░░░░░░░░░░░░ | `packages/devhub-storage/` |
| Vectorstore: Interface + ChromaDB | C | S | 📋 KLAAR | ░░░░░░░░░░░░ | `packages/devhub-vectorstore/` |
...
|--------|-------|------|--------|------|------------------|
| Storage: Google Drive adapter | B | S | ⏳ WACHT | ░░░░░░░░░░░░ | Track B S1 |
| Vectorstore: Weaviate + Multi-tenancy | C | S | ⏳ WACHT | ░░░░░░░░░░░░ | Track C S1 |
...
| 7 | Quick Fixes | XS (<1.5u) | ? | ? | ? |
| 8 | Planning Opschoning | XS (<1u) | ? | ? | ? |
...
|--------|--------|-------------|
| Sprints afgerond | 6 | Alle binnen geschatte tijd |
| Gemiddelde test-delta | +29.5 | Per sprint (excl. UV workspace) |
| Schattingsnauwkeurigheid | 100% | 6/6 sprints binnen appetite |
| Gemiddelde sprint-grootte | S-M | Nog geen punten-systeem |
...
| Quick Fixes | 2026-03-25 | 2026-03-26 | ? | ? |
...
### Voorgestelde Golf 1 capaciteit

| Week | Beschikbaar | Allocatie |
|------|-------------|-----------|
| Week 1 | Normaal | Planning Opschoning (XS) + Track B S1 start + Track C S1 start |
| Week 2 | Normaal | Track B S1 + Track C S1 afronden |
| Week 3 | Normaal | Mentor S1 of Governance S1 (keuze bij Golf 1 review) |
...
|---|--------|--------|--------|-----------|
| R1 | Track B+C patroon-inconsistentie | Hoog | OPEN | Cross-referentie in beide intakes; eerste sprint consistent reviewen |
